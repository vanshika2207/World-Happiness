...
#loading the dataset
happiness_2015 = pd.read_csv("Happiness.py/2015.csv")
...
happiness_2016 =  pd.read_csv("Happiness.py/2016.csv")
...
dropped_2016.columns = ['Country', 'Happiness_Rank', 'Happiness_Score','Economy', 'Family',
       'Health', 'Freedom', 'Trust',
       'Generosity', 'Dystopia_Residual']
happiness_2017 =  pd.read_csv("Happiness.py/2017.csv")
...
dropped_2017.columns = ['Country', 'Happiness_Rank', 'Happiness_Score','Economy', 'Family',
       'Health', 'Freedom', 'Trust',
       'Generosity', 'Dystopia_Residual']
happiness_2018=pd.read_csv('Happiness.py/2018.CSV')
...
happiness_2019=pd.read_csv('Happiness.py/2019.csv')
